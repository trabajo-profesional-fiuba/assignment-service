...
class TopicTutorAssignmentFlowSolver():
    ...
    def create_tutors_sink_edges(self):
        ...
        tutor_sink_edges = [(tutor.id, SINK_NODE_ID, {"capacity": tutor.capacity,
                            "weight": 1}) for i, tutor in enumerate(self._tutors)]
    ...
    def create_edges(self):
        ...
        return team_topic_edges + source_groups_edges + topic_tutor_edges + tutor_sink_edges
