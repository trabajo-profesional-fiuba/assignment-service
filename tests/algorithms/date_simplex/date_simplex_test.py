...
class TestDatesSimplex:
    ...
    # possible_dates = [DateDto( 1,"lunes", 1), DateDto( 1, "lunes",2),
    #                   DateDto( 1,"lunes", 3), DateDto( 1,"lunes", 4),
    #                   DateDto( 1, "lunes",5), DateDto( 1, "lunes",6),
    #                   DateDto( 1,"lunes", 7), DateDto( 1, "lunes",8),
    #                   DateDto( 1, "lunes",9), DateDto( 1, "lunes",10),
    #                   DateDto( 1,"lunes", 11),
    #                   DateDto( 2, "martes",1), DateDto( 2, "martes",2),
    #                   DateDto(2,"martes",  3), DateDto(2,"martes",  4),
    #                   DateDto(2,"martes",  5), DateDto(2,"martes",  6),
    #                   DateDto(2,"martes",  7),
    #                   DateDto( 2,"martes", 8), DateDto( 2,"martes", 9),
    #                   DateDto( 2,"martes", 10), DateDto( 2,"martes", 11),
    #                   DateDto( 3,"miercoles", 1), DateDto( 3,"miercoles", 2),
    #                   DateDto( 3,"miercoles", 3), DateDto( 3,"miercoles", 4),
    #                   DateDto( 3,"miercoles", 5), DateDto( 3,"miercoles", 6),
    #                   DateDto( 3,"miercoles", 7),
    #                   DateDto( 3,"miercoles", 8), DateDto( 3,"miercoles", 9),
    #                   DateDto( 3,"miercoles", 10), DateDto( 3,"miercoles", 11),
    #                   DateDto( 4,"miercoles", 1), DateDto( 4,"miercoles", 2),
    #                   DateDto( 4,"miercoles", 3), DateDto( 4,"miercoles", 4),
    #                   DateDto("miercoles", 4, 5), DateDto("miercoles", 4, 6),
    #                   DateDto("miercoles", 4, 7),
    #                   DateDto( 4,"miercoles", 8), DateDto( 4,"miercoles", 9),
    #                   DateDto( 4,"miercoles", 10), DateDto( 4,"miercoles", 11),
    #                   DateDto(5,"friday", 1), DateDto(5,"friday", 2),
    #                   DateDto(5,"friday", 3), DateDto(5,"friday", 4),
    #                   DateDto(5,"friday", 5), DateDto(5,"friday", 6),
    #                   DateDto(5,"friday", 7), DateDto(5,"friday", 8),
    #                   DateDto(5,"friday", 9), DateDto(5,"friday", 10),
    #                   DateDto(5,"friday", 11)]
    ...
    #                   possible_dates[44:55], tutor_id="t2"
    #         ),
    #     ]
    #     tutors = [
    #         FinalStateTutor(id="t1",
    #           available_dates=possible_dates[0:11]+
    #               possible_dates[33:44]+
    #               possible_dates[44:55]) ,
    #         FinalStateTutor(id="t2",
    #           available_dates=possible_dates[11:22]+
    #               possible_dates[22:33]+
    #               possible_dates[44:55]),
    #         FinalStateTutor(id="t3",
    #           available_dates=possible_dates[22:33]+
    #           possible_dates[33:44]),
    #     ]
    #     evaluators = [
